...
packages\OpenCover.%OPENCOVERVERSION%\OpenCover.Console.exe -register:user -target:Build\Nunit.%NUNITVERSION%\bin\nunit-console-x86.exe -targetargs:"/noshadow /nodots NokiaMusicApiTests\bin\Debug\Nokia.Music.Tests.dll" -filter:"+[Nokia.Music.Tests]* -[Nokia.Music.Tests]Nokia.Music.Phone.Tests* -[Nokia.Music.Tests]Ionic*" -output:TestCoverage.xml
