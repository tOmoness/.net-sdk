...
namespace Nokia.Music.TestApp
{
    ...
    public partial class GenrePage : PhoneApplicationPage
    {
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            App.ApiClient.GetTopArtistsForGenre(this.TopArtistsResponseHandler, this._genreId, 0, 10);

            this.LoadingTopAlbums.Visibility = Visibility.Visible;
            App.ApiClient.GetTopProductsForGenre(this.TopAlbumsResponseHandler, this._genreId, Category.Album, 0, 10);

            this.LoadingTopSongs.Visibility = Visibility.Visible;
            App.ApiClient.GetTopProductsForGenre(this.TopSongsResponseHandler, this._genreId, Category.Track, 0, 10);

            this.LoadingNewAlbums.Visibility = Visibility.Visible;
            App.ApiClient.GetNewReleasesForGenre(this.NewAlbumsResponseHandler, this._genreId, Category.Album, 0, 10);

            this.LoadingNewSongs.Visibility = Visibility.Visible;
            App.ApiClient.GetNewReleasesForGenre(this.NewSongsResponseHandler, this._genreId, Category.Track, 0, 10);
        }
