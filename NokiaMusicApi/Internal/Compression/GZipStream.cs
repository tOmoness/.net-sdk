...
namespace Ionic.Zlib
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="ZlibStream"/> and DeflateStream.
    ///   <c>ZlibStream</c> handles RFC1950-compliant streams.
        ...
        public string FileName
        {
            ...
            set
            {
                ...
                if (_FileName.IndexOf("\\") != -1)
                {
                    ...
                    _FileName = _FileName.Substring(_FileName.LastIndexOf("\\") + "\\".Length);
                }
            }
        }
